<?php $__env->startSection('container'); ?>
    ...
    <?php if($posts->count()): ?>
        <div class="card mb-3">
            <img src="https://source.unsplash.com/1900x400?<?php echo e($posts[0]->category->name); ?>" class="card-img-top"
                alt="<?php echo e($posts[0]->category->name); ?>">
            <div class="card-body text-center">
                <h3 class="card-title"><a href="/posts/<?php echo e($posts[0]->slug); ?>" class="text-dark"><?php echo e($posts[0]->title); ?></a>
                </h3>
                <p>
                    <small class="text-muted">By. <a
                            href="/posts?author=<?php echo e($posts[0]->author->username); ?>"><?php echo e($posts[0]->author->name); ?></a> in <a
                            href="/posts?category=<?php echo e($posts[0]->category->slug); ?>"><?php echo e($posts[0]->category->name); ?></a>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <div class="position-absolute px-3 py-2" style="background-color: rgba(0, 0, 0, 0.5)"><a
                                    ...
                                    class="text-white"><?php echo e($post->category->name); ?></a></div>
                            <img src="https://source.unsplash.com/500x500?<?php echo e($post->category->name); ?>" class="card-img-top"
                                alt="<?php echo e($post->category->name); ?>">
                            <div class="card-body">
                                <h5 class="card-title"><?php echo e($post->title); ?></h5>
                                <p><small class="text-muted">By. <a
                                            href="/posts?author=<?php echo e($post->author->username); ?>"><?php echo e($posts[0]->author->name); ?></a>
