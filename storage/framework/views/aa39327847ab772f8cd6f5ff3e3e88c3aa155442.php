                ...
                <form action="/register" method="POST">
                    ...
                    <div class="form-floating">
                        <input type="text" name="name"
                            class="form-control rounded-top <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>"
                            id="floatingInput" placeholder="name@example.com" required value="<?php echo e(old('email')); ?>">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\Website_Belajar\resources\views/register/index.blade.php ENDPATH**/ ?>